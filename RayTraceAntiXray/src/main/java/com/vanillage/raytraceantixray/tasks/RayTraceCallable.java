        ...
        cachedSectionBlockOcclusionGetter = new CachedSectionBlockOcclusionGetter() {
            ...
            public boolean isOccluding(int x, int y, int z) {
                ...
                if (this.chunkX != chunkX || this.chunkZ != chunkZ) {
                    ...
                    return section != null && !section.hasOnlyAir() && solidGlobal[ChunkPacketBlockControllerAntiXray.getGlobalBlockStateId(getBlockState(section, x, y, z))]; // Sections aren't null anymore. Unfortunately, LevelChunkSection#recalcBlockCounts() temporarily resets #nonEmptyBlockCount to 0 due to a Paper optimization.
                }
                ...
                return solidGlobal[ChunkPacketBlockControllerAntiXray.getGlobalBlockStateId(getBlockState(section, x, y, z))];
            }
